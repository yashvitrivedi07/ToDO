...
import 'package:to_do_application/component/profile.dart';
...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    body: Obx(() {
      List<Widget> components = (controller.isEmpty.value == false)
          ? [IndexComponent(), CalendarComponent(), FocusComponent(), Profile()]
          : [TaskComponent(), CalendarComponent(), FocusComponent(), Profile()];
    ...
    floatingActionButton: FloatingActionButton(
      shape: CircleBorder(),
      onPressed: () {
        Get.bottomSheet(NewTaskComponent(),
    ...
    bottomNavigationBar: Obx(() {
      return NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(icon: Icon(Icons.person_3_outlined), label: "Profile"),
        ],
      );
    }),
  );
